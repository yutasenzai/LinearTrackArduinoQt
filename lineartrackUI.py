...
#
# Created: Sat Jan 05 15:34:52 2013
...
class Ui_LinearTrackUI(object):
    def setupUi(self, LinearTrackUI):
        ...
        self.gfx_sensor_left.setAutoFillBackground(False)
        ...
        self.gfx_sensor_right.setAutoFillBackground(False)
        ...
        self.layoutWidget = QtGui.QWidget(LinearTrackUI)
        self.layoutWidget.setGeometry(QtCore.QRect(290, 110, 92, 83))
        self.layoutWidget.setObjectName(_fromUtf8("layoutWidget"))
        self.Group_Right = QtGui.QVBoxLayout(self.layoutWidget)
        self.Group_Right.setMargin(0)
        self.Group_Right.setObjectName(_fromUtf8("Group_Right"))
        self.lbl_right_water = QtGui.QLabel(self.layoutWidget)
        ...
        self.spin_right_waterreward = QtGui.QSpinBox(self.layoutWidget)
        self.spin_right_waterreward.setToolTip(_fromUtf8(""))
        self.spin_right_waterreward.setAccelerated(True)
        self.spin_right_waterreward.setMaximum(10000)
        self.spin_right_waterreward.setSingleStep(1)
        ...
        self.lbl_right_waterreward = QtGui.QLabel(self.layoutWidget)
        ...
        self.lcd_right_triggers = QtGui.QLCDNumber(self.layoutWidget)
        self.lcd_right_triggers.setObjectName(_fromUtf8("lcd_right_triggers"))
        self.Group_Right.addWidget(self.lcd_right_triggers)
        self.layoutWidget1 = QtGui.QWidget(LinearTrackUI)
        self.layoutWidget1.setGeometry(QtCore.QRect(30, 110, 92, 83))
        self.layoutWidget1.setObjectName(_fromUtf8("layoutWidget1"))
        self.Group_Left = QtGui.QVBoxLayout(self.layoutWidget1)
        self.Group_Left.setMargin(0)
        self.Group_Left.setObjectName(_fromUtf8("Group_Left"))
        self.lbl_left_water = QtGui.QLabel(self.layoutWidget1)
        ...
        self.spin_left_waterreward = QtGui.QSpinBox(self.layoutWidget1)
        self.spin_left_waterreward.setEnabled(True)
        self.spin_left_waterreward.setToolTip(_fromUtf8(""))
        self.spin_left_waterreward.setAccelerated(True)
        self.spin_left_waterreward.setMaximum(10000)
        self.spin_left_waterreward.setSingleStep(1)
        ...
        self.lbl_left_waterreward = QtGui.QLabel(self.layoutWidget1)
        ...
        self.lcd_left_triggers = QtGui.QLCDNumber(self.layoutWidget1)
    ...
    def retranslateUi(self, LinearTrackUI):
        ...
        self.lbl_runtime.setDisplayFormat(QtGui.QApplication.translate("LinearTrackUI", "h:mm:ss", None, QtGui.QApplication.UnicodeUTF8))
